...
export default function VehicleJourney({ onBack, onSanctioned, userName }: VehicleJourneyProps) {
  ...
  const [sanctionedApp, setSanctionedApp] = useState<SanctionedApp | null>(null);
